...
function SafetyGauge({ score }: { score: number }) {
  ...
  const color = score > 85 ? '#2E7D32' : score > 60 ? '#C48A00' : '#C84A4A';

  return (
    <div style={{ position: 'relative', width: size, height: size, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <svg width={size} height={size} className="transform -rotate-90" style={{ position: 'absolute', inset: 0 }}>
        {/* Track */}
        <circle cx={size/2} cy={size/2} r={r} stroke="rgba(0,0,0,0.05)" strokeWidth={strokeWidth} fill="none" />
        {/* Zone: danger 0–60 */}
        <circle cx={size/2} cy={size/2} r={r} stroke="rgba(200,74,74,0.08)" strokeWidth={strokeWidth} fill="none"
          strokeDasharray={`${circ * 0.60} ${circ * 0.40}`} strokeDashoffset={0} />
        {/* Zone: warning 60–85 */}
        <circle cx={size/2} cy={size/2} r={r} stroke="rgba(196,138,0,0.08)" strokeWidth={strokeWidth} fill="none"
          strokeDasharray={`${circ * 0.25} ${circ * 0.75}`} strokeDashoffset={-(circ * 0.60)} />
        {/* Zone: safe 85–100 */}
        <circle cx={size/2} cy={size/2} r={r} stroke="rgba(46,125,50,0.08)" strokeWidth={strokeWidth} fill="none"
      ...
      <div style={{ textAlign: 'center', zIndex: 10 }}>
        ...
        <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 700, color: 'rgba(0,0,0,0.25)', letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginTop: '4px' }}>
          / 100
        </span>
      </div>
    </div>
    ...
    return (
      <div style={{ height: 'calc(100vh - 48px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div className="glass-card" style={{ maxWidth: '400px', padding: '48px', borderRadius: '24px', textAlign: 'center' }}>
          ...
          <h3 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '18px', color: '#1C1C1C', marginBottom: '10px' }}>Analytics Offline</h3>
          ...
          <code style={{ display: 'block', fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', color: 'rgba(0,0,0,0.35)', background: 'rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.07)', borderRadius: '8px', padding: '10px', marginTop: '14px', wordBreak: 'break-all' }}>
            {socketUrl}
          </code>
        </div>
      </div>
    ...
    return (
      <div style={{ height: 'calc(100vh - 48px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', fontWeight: 600, letterSpacing: '0.10em', color: 'rgba(0,0,0,0.25)', textTransform: 'uppercase' }}>Connecting Analytics...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div style={{ marginBottom: '56px' }}>
          ...
          >
            ...
            <span style={{ color: 'rgba(28,28,28,0.40)' }}>Analytics</span></span>
          </h1>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '15px', color: 'rgba(28,28,28,0.40)', lineHeight: 1.7 }}>
        ...
        >
          {[
            ...
            { label: 'Capacity Used',    value: `${capacityPct}%`,               unit: 'of 85,000',  color: '#2E7D32' },
            { label: 'Safety Score',     value: `${safetyScore}%`,               unit: 'global index', color: safetyColor },
            { label: 'AI Accuracy',      value: `${predAccuracy}%`,              unit: 'prediction',  color: '#6BCB6E' },
          ].map((m, i) => (
            <motion.div
              key={m.label}
              initial={{ opacity: 0 }}
            ...
            >
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.25)' }}>{m.label}</span>
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '12px', color: 'rgba(0,0,0,0.25)' }}>{m.unit}</span>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-4">
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 600, color: 'rgba(0,0,0,0.25)', letterSpacing: '0.10em', textTransform: 'uppercase' }}>Global Safety Score</p>
            </div>
          </div>
          ...
          <div className="glass-panel lg:col-span-7 rounded-[20px] p-6 lg:p-9 min-h-[360px]">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
              <div>
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: 'rgba(0,0,0,0.30)' }}>Real-time attendance vs projected capacity</p>
              </div>
              <div style={{ textAlign: 'right' }}>
                <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 900, fontSize: '44px', color: '#2E7D32', letterSpacing: '-0.05em', lineHeight: 1.0, display: 'block' }}>
                  {totalAttendance.toLocaleString()}
                </span>
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', fontWeight: 600, color: 'rgba(0,0,0,0.25)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            ...
            {/* Full capacity bar */}
            <div style={{ width: '100%', height: '4px', background: 'rgba(0,0,0,0.06)', borderRadius: '9999px', overflow: 'hidden', marginBottom: '28px' }}>
              <div style={{ height: '100%', width: `${capacityPct}%`, background: 'linear-gradient(90deg, #1B5E20, #2E7D32)', borderRadius: '9999px', transition: 'width 700ms cubic-bezier(0.25,0.46,0.45,0.94)' }} />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-5 pt-6 border-t border-[rgba(0,0,0,0.06)]">
              {stands.map(stand => {
                ...
                return (
                  <div key={stand.label}>
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, color: 'rgba(0,0,0,0.25)', letterSpacing: '0.10em', textTransform: 'uppercase', display: 'block', marginBottom: '8px' }}>
                      {stand.label.replace(' Stand', '')}
                    </span>
                    <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 800, fontSize: '22px', color: '#1C1C1C', letterSpacing: '-0.03em', lineHeight: 1.0, display: 'block', marginBottom: '8px' }}>
                      {stand.val.toLocaleString()}
                    </span>
                    <div style={{ width: '100%', height: '3px', background: 'rgba(0,0,0,0.06)', borderRadius: '9999px', overflow: 'hidden', marginBottom: '4px' }}>
                    ...
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 600, color: 'rgba(0,0,0,0.25)' }}>{pct}% full</span>
                  </div>
                );
              })}
            </div>
                ...
                return (
                  <div key={stand.label}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '8px' }}>
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', fontWeight: 600, color: '#1C1C1C' }}>{stand.label}</span>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', fontWeight: 700, color: 'rgba(0,0,0,0.45)' }}>
                        {stand.val.toLocaleString()} <span style={{ color: 'rgba(0,0,0,0.20)', fontWeight: 400 }}>/ {stand.cap.toLocaleString()}</span>
                      </span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <div style={{ flexGrow: 1, height: '4px', background: 'rgba(0,0,0,0.06)', borderRadius: '9999px', overflow: 'hidden' }}>
                        <div style={{ height: '100%', width: `${pct}%`, background: barColor, borderRadius: '9999px', transition: 'width 700ms cubic-bezier(0.25,0.46,0.45,0.94)' }} />
                      </div>
          ...
          <div className="glass-panel relative flex flex-col items-center justify-center gap-4 rounded-[20px] p-6 lg:p-7 min-h-[280px]">
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 900, fontSize: '22px', color: '#6BCB6E', letterSpacing: '-0.03em' }}>{predAccuracy}%</span>
              </div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '14px', color: '#1C1C1C', marginBottom: '3px' }}>Prediction Accuracy</p>
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 600, color: 'rgba(0,0,0,0.25)', letterSpacing: '0.10em', textTransform: 'uppercase' }}>AI Orchestrator</p>
            </div>
          </div>
          ...
          <div className="glass-panel rounded-[20px] p-6 lg:p-7">
            ...
            >
              {Object.values(state.zones).map(z => {
                const statusColor = z.status === 'critical' ? '#C84A4A' : z.status === 'warning' ? '#C48A00' : '#2E7D32';
                return (
                  <div
                    key={z.id}
                    style={{
                  ...
                  >
                    <div>
                      <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 600, fontSize: '12px', color: '#1C1C1C', display: 'block' }}>{z.name}</span>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', color: 'rgba(0,0,0,0.25)', fontWeight: 600, letterSpacing: '0.04em', marginTop: '2px', display: 'block' }}>
