...
function ArcGauge({ value, size = 80, strokeWidth = 6, color = '#6F00FF' }: {
...
function KPICard({
  ...
  return (
    <div
      ...
      style={{
        borderColor: pulse ? 'rgba(248,113,113,0.20)' : undefined,
      }}
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: '4px' }}>
        {children}
        <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 900, fontSize: '40px', letterSpacing: '-0.04em', lineHeight: 1.0, color: color || '#FFFFFF' }}>
          {value}
        </span>
  ...
  if (hasError && (!state || !analytics)) {
    return (
      <div style={{ height: 'calc(100vh - 48px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        >
          <span className="material-symbols-outlined" style={{ fontSize: '40px', color: '#F87171', display: 'block', marginBottom: '16px' }}>cloud_off</span>
          <h3 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '18px', color: '#FFFFFF', marginBottom: '10px' }}>Telemetry Backend Offline</h3>
    ...
    return (
      <div style={{ height: 'calc(100vh - 48px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ width: '32px', height: '32px', border: '2px solid #6F00FF', borderTopColor: 'transparent', borderRadius: '50%', animation: 'spin 1s linear infinite', margin: '0 auto 16px' }} />
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px' }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '4px 10px', background: 'rgba(111,0,255,0.08)', border: '1px solid rgba(111,0,255,0.15)', borderRadius: '9999px' }}>
              <span className="w-1.5 h-1.5 rounded-full pulse-live" style={{ background: '#6F00FF' }} />
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.10em', textTransform: 'uppercase' }}>LIVE</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card" style={{ padding: '12px 20px', borderRadius: '14px', display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '20px', fontWeight: 700, color: '#FFFFFF', letterSpacing: '0.02em', lineHeight: 1.2 }}>{clock}</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '20px' }}>
        ...
        <KPICard
          ...
          color={activeIncidentsCount > 0 ? '#F87171' : '#FFFFFF'}
        ...
        <div className="glass-card rounded-2xl p-5">
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '10px' }}>
            <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 900, fontSize: '32px', letterSpacing: '-0.04em', lineHeight: 1.0, color: '#FFFFFF' }}>{totalOccupancy.toLocaleString()}</span>
          ...
          <div style={{ width: '100%', height: '3px', background: 'rgba(255,255,255,0.06)', borderRadius: '9999px', overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${capacityPct}%`, background: '#6F00FF', borderRadius: '9999px', transition: 'width 700ms cubic-bezier(0.25,0.46,0.45,0.94)' }} />
          </div>
          ...
          >
            <button
              ...
              style={{
                ...
                borderRadius: '50%',
                border: 'none',
                background: isPlaying ? '#6F00FF' : 'rgba(255,255,255,0.08)',
                color: isPlaying ? '#0F061A' : '#FFFFFF',
                cursor: 'pointer',
                display: 'flex',
                alignItems: 'center',
            ...
            <div style={{ flexGrow: 1, display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div style={{ flexGrow: 1, position: 'relative' }}>
                <input
                  ...
                  style={{
                    ...
                    height: '3px',
                    borderRadius: '9999px',
                    background: `linear-gradient(to right, #6F00FF 0%, #6F00FF ${(state.elapsedMinutes / 95) * 100}%, rgba(255,255,255,0.08) ${(state.elapsedMinutes / 95) * 100}%, rgba(255,255,255,0.08) 100%)`,
                  }}
                />
              ...
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '16px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.02em', minWidth: '36px' }}>{state.elapsedMinutes}m</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div
            style={{
              ...
              borderBottom: '1px solid rgba(111,0,255,0.08)',
              display: 'flex',
              alignItems: 'center',
              gap: '12px',
            }}
          >
            <div
              style={{
                ...
                justifyContent: 'center',
                flexShrink: 0,
                boxShadow: '0 0 20px rgba(111,0,255,0.30)',
              }}
            >
              <span className="material-symbols-outlined" style={{ fontSize: '18px', color: '#0F061A', fontVariationSettings: "'FILL' 1" }}>smart_toy</span>
            </div>
            <div>
              <h3 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 800, fontSize: '16px', color: '#FFFFFF', letterSpacing: '-0.02em', lineHeight: 1.1 }}>AI Copilot</h3>
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.12em', textTransform: 'uppercase' }}>Predictive Operations</p>
            </div>
          </div>
              ...
              {activeEvent && scenDetails ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <h4 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '15px', color: '#FFFFFF', letterSpacing: '-0.015em', lineHeight: 1.3 }}>
                      {activeEvent.title}
                    </h4>
                  </div>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                            <div
                              style={{
                                ...
                                height: '18px',
                                borderRadius: '50%',
                                background: isCurrent ? '#6F00FF' : isPast ? 'rgba(111,0,255,0.20)' : 'rgba(255,255,255,0.06)',
                                border: isCurrent ? '2px solid #6F00FF' : 'none',
                                boxShadow: isCurrent ? '0 0 10px rgba(111,0,255,0.40)' : 'none',
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                              }}
                            >
                              {isPast && <span className="material-symbols-outlined" style={{ fontSize: '10px', color: '#6F00FF', fontVariationSettings: "'FILL' 1" }}>check</span>}
                              {isCurrent && <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#0F061A' }} />}
                            </div>
                            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '6px', fontWeight: 700, color: isCurrent ? '#6F00FF' : isPast ? 'rgba(111,0,255,0.50)' : 'rgba(255,255,255,0.15)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                              {phase.label}
                            </span>
                          </div>
                          {idx < phasesList.length - 1 && (
                            <div style={{ flexGrow: 1, height: '1px', background: idx < phasesList.findIndex(p => p.key === activeEvent.currentPhase) ? 'rgba(111,0,255,0.25)' : 'rgba(255,255,255,0.05)', marginBottom: '14px' }} />
                          )}
                        </React.Fragment>
                      );
                    })}
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                    <div style={{ padding: '12px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px' }}>
                      ...
                      <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 900, fontSize: '24px', color: '#E9B3FB', letterSpacing: '-0.03em' }}>{activeEvent.probability}%</span>
                    </div>
                    <div style={{ padding: '12px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px' }}>
                      ...
                      <span style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 900, fontSize: '24px', color: '#F87171', letterSpacing: '-0.03em' }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '10px' }}>
                      {scenDetails.resources.map((res, i) => (
                        <span key={i} style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 600, color: '#6F00FF', background: 'rgba(111,0,255,0.08)', border: '1px solid rgba(111,0,255,0.15)', borderRadius: '9999px', padding: '3px 10px', letterSpacing: '0.04em' }}>
                          {res}
                        </span>
                      ))}
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '8px' }}>
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.06em' }}>{scenDetails.resolutionTime}</span>
                    </div>
                  </div>
                        ...
                        return (
                          <div key={step.id} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '8px 10px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '10px' }}>
                            <span
                              ...
                              style={{ fontSize: '14px', color: isExecuted ? '#6F00FF' : isExecuting ? '#E9B3FB' : 'rgba(255,255,255,0.15)', flexShrink: 0, fontVariationSettings: "'FILL' 1" }}
                            >
                ...
                >
                  <div style={{ width: '56px', height: '56px', borderRadius: '50%', background: 'rgba(111,0,255,0.08)', border: '1px solid rgba(111,0,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <span className="material-symbols-outlined" style={{ fontSize: '28px', color: '#6F00FF', fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                  </div>
                  <div>
                    <p style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '15px', color: '#FFFFFF', marginBottom: '6px' }}>System Nominal</p>
                    ...
                    <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.12em', textTransform: 'uppercase', marginTop: '16px' }}>Telemetry Link: GREEN</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          {/* Deploy Button */}
          {activeEvent && (
            <div style={{ padding: '16px 20px', borderTop: '1px solid rgba(111,0,255,0.08)' }}>
              {executingEventId === activeEvent.id ? (
                ...
                >
                  {!isComplete && <div style={{ width: '12px', height: '12px', border: '2px solid #6F00FF', borderTopColor: 'transparent', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />}
                  {isComplete && <span className="material-symbols-outlined animate-check-in" style={{ fontSize: '16px', color: '#6F00FF', fontVariationSettings: "'FILL' 1" }}>check_circle</span>}
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.10em', textTransform: 'uppercase' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', paddingBottom: '14px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span className="w-1.5 h-1.5 rounded-full pulse-live" style={{ background: '#6F00FF' }} />
              <h3 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '15px', color: '#FFFFFF', letterSpacing: '-0.015em' }}>Live Event Feed</h3>
            </div>
              ...
              >
                <div
                  style={{
                    ...
                    alignItems: 'center',
                    justifyContent: 'center',
                    background: item.severity === 'critical' ? 'rgba(248,113,113,0.10)' : item.severity === 'warning' ? 'rgba(250,204,21,0.10)' : 'rgba(111,0,255,0.08)',
                  }}
                >
                  <span
                    className="material-symbols-outlined"
                    style={{ fontSize: '13px', fontVariationSettings: "'FILL' 1", color: item.severity === 'critical' ? '#F87171' : item.severity === 'warning' ? '#FACC15' : '#6F00FF' }}
                  >
                ...
                <div style={{ flexGrow: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <h4 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 600, fontSize: '12px', color: '#FFFFFF', lineHeight: 1.3 }}>{item.title}</h4>
                  ...
                  {item.zoneId && (
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.08em', textTransform: 'uppercase' as const, display: 'block', marginTop: '2px' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px', paddingBottom: '14px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
            <span className="material-symbols-outlined" style={{ fontSize: '16px', color: '#E9B3FB', fontVariationSettings: "'FILL' 1" }}>monitoring</span>
            <h3 style={{ fontFamily: "'Mona Sans', 'Hanken Grotesk', sans-serif", fontWeight: 700, fontSize: '14px', color: '#FFFFFF', letterSpacing: '-0.015em' }}>AI Impact Forecast</h3>
          </div>

          {activeEvent && scenDetails ? (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', flexGrow: 1 }}>
              {/* Without AI */}
              <div style={{ padding: '14px', borderRadius: '12px', background: 'rgba(248,113,113,0.04)', border: '1px solid rgba(248,113,113,0.12)', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, color: '#F87171', letterSpacing: '0.10em', textTransform: 'uppercase' }}>Without AI</span>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', flexGrow: 1 }}>
                  {[
                    ...
                    <div key={m.label} style={{ display: 'flex', justifyContent: 'space-between' }}>
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', fontWeight: 700, color: '#F87171' }}>{m.value}</span>
                    </div>
                  ))}
                </div>
                <div style={{ borderTop: '1px solid rgba(248,113,113,0.10)', paddingTop: '8px' }}>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, color: '#F87171', letterSpacing: '0.06em' }}>AFFECTED: {scenDetails.noAction.affected}</span>
                </div>
              </div>

              {/* With ArenaFlow AI */}
              <motion.div
                animate={isComplete ? { borderColor: 'rgba(111,0,255,0.30)', background: 'rgba(111,0,255,0.06)' } : {}}
                transition={{ duration: 0.4 }}
                style={{ padding: '14px', borderRadius: '12px', background: 'rgba(111,0,255,0.03)', border: '1px solid rgba(111,0,255,0.12)', display: 'flex', flexDirection: 'column', gap: '8px' }}
              >
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.10em', textTransform: 'uppercase' }}>ArenaFlow AI</span>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', flexGrow: 1 }}>
                  {[
                    ...
                    <div key={m.label} style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: 'rgba(255,255,255,0.35)' }}>{m.label}</span>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', fontWeight: 700, color: '#6F00FF' }}>{m.value}</span>
                    </div>
                  ))}
                </div>
                <div style={{ borderTop: '1px solid rgba(111,0,255,0.12)', paddingTop: '8px' }}>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, color: '#6F00FF', letterSpacing: '0.06em' }}>RESOLVED: {scenDetails.withAI.time}</span>
                </div>
              </motion.div>
            </div>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flexGrow: 1, textAlign: 'center', gap: '10px' }}>
              <span className="material-symbols-outlined" style={{ fontSize: '24px', color: '#6F00FF', opacity: 0.3, fontVariationSettings: "'FILL' 1" }}>check_circle</span>
