...
function getDarkStatusColors(zone: {
  ...
  if (telemetryMode === 'wait') {
    if (zone.waitTime > 25)
      return { fill: 'rgba(255,68,68,0.07)', stroke: 'rgba(255,68,68,0.32)', hoverFill: 'rgba(255,68,68,0.13)' };
    if (zone.waitTime > 8)
      return { fill: 'rgba(255,184,0,0.07)', stroke: 'rgba(255,184,0,0.32)', hoverFill: 'rgba(255,184,0,0.13)' };
    return { fill: 'rgba(0,212,106,0.06)', stroke: 'rgba(0,212,106,0.22)', hoverFill: 'rgba(0,212,106,0.11)' };
  }
...
const SEG_BTN = (active: boolean): React.CSSProperties => ({
  ...
  background: active ? 'rgba(0,212,106,0.15)' : 'transparent',
  color: active ? '#00D46A' : 'rgba(255,255,255,0.35)',
  boxShadow: active ? '0 0 12px rgba(0,212,106,0.18)' : 'none',
});
...
export default function StadiumMap() {
  ...
  const riskColor = (status: string) =>
    status === 'critical' ? '#FF4444' : status === 'warning' ? '#FFB800' : '#00D46A';
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: '200px',
          height: '280px',
          background: 'radial-gradient(ellipse at center, rgba(0,212,106,0.08) 0%, transparent 70%)',
          filter: 'blur(80px)',
          pointerEvents: 'none',
          zIndex: 1,
        }}
      ...
      >
        <defs>
          <radialGradient id="dtRadarGrad" cx="400" cy="300" r="350" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="rgba(0,212,106,0.05)" />
            <stop offset="100%" stopColor="rgba(0,212,106,0)" />
          </radialGradient>
          <style>{`
        ...
        {([
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              b.style.borderColor = 'rgba(0,212,106,0.40)';
              b.style.color = '#00D46A';
              b.style.boxShadow = '0 0 16px rgba(0,212,106,0.20)';
            }}
            onMouseLeave={e => {
              const b = e.currentTarget;
      ...
      >
        <defs>
          ...
          <radialGradient id="dtPitchGlow" cx="50%" cy="50%" r="50%">
            <stop offset="0%"   stopColor="#00D46A" stopOpacity="0.06" />
        ...
        >
          ...
          <g stroke="rgba(0,212,106,0.12)" strokeWidth="1" strokeDasharray="4 4" fill="none">
                  ...
                  <>
                    {zone.status !== 'optimal' && (
                      <circle
                        cx={zone.x} cy={zone.y} r={zone.r + 6}
                        fill="none"
                        stroke={zone.status === 'critical' ? 'rgba(255,68,68,0.50)' : 'rgba(255,184,0,0.50)'}
                        strokeWidth={1.5}
        ...
        {hoveredZone && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 8px 32px rgba(0,0,0,0.60), inset 0 0 0 1px rgba(0,212,106,0.08)',
              zIndex: 30,
              pointerEvents: 'none',
              display: 'flex',
              flexDirection: 'column',
          ...
          >
            ...
            {[
              ...
              <div key={r.label} style={{ display: 'flex', justifyContent: 'space-between', gap: '24px' }}>
                ...
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', color: '#F0F0EE', fontWeight: 700 }}>{r.value}</span>
              </div>
            ))}
        ...
        {selectedZone && (
          <motion.div
            ...
            style={{
              ...
              padding: '16px',
              backdropFilter: 'blur(24px)',
              boxShadow: '0 16px 48px rgba(0,0,0,0.70), inset 0 0 0 1px rgba(0,212,106,0.06)',
              zIndex: 20,
              display: 'flex',
              flexDirection: 'column',
            }}
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, letterSpacing: '0.18em', color: '#00D46A', textTransform: 'uppercase' }}>
                Zone Inspector
              </span>
              <button
            ...
            <h4 style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', fontWeight: 700, color: '#F0F0EE', letterSpacing: '0.05em', marginBottom: '14px' }}>
              {selectedZone.name}
            </h4>
