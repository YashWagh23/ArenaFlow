...
function getDarkStatusColors(zone: {
  ...
  if (!heatmapActive) {
    return {
      fill: 'rgba(255,255,204,0.04)',
      stroke: 'rgba(255,255,204,0.10)',
      hoverFill: 'rgba(255,255,204,0.07)',
    };
  }
  if (telemetryMode === 'wait') {
    if (zone.waitTime > 25)
      return { fill: 'rgba(232,108,93,0.07)', stroke: 'rgba(232,108,93,0.32)', hoverFill: 'rgba(232,108,93,0.13)' };
    if (zone.waitTime > 8)
      return { fill: 'rgba(243,201,105,0.07)', stroke: 'rgba(243,201,105,0.32)', hoverFill: 'rgba(243,201,105,0.13)' };
    return { fill: 'rgba(255,255,204,0.06)', stroke: 'rgba(255,255,204,0.22)', hoverFill: 'rgba(255,255,204,0.11)' };
  }
...
const SEG_BTN = (active: boolean): React.CSSProperties => ({
  ...
  background: active ? 'rgba(255,255,204,0.15)' : 'transparent',
  color: active ? '#FFFFCC' : 'rgba(255,255,204,0.35)',
  boxShadow: active ? '0 0 12px rgba(255,255,204,0.18)' : 'none',
});
...
export default function StadiumMap() {
  ...
  const riskColor = (status: string) =>
    status === 'critical' ? '#E86C5D' : status === 'warning' ? '#F3C969' : '#FFFFCC';
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          inset: 0,
          backgroundImage:
            'linear-gradient(rgba(255,255,204,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,204,0.03) 1px, transparent 1px)',
      ...
      <div
        ...
        style={{
          ...
          width: '200px',
          height: '280px',
          background: 'radial-gradient(ellipse at center, rgba(255,255,204,0.08) 0%, transparent 70%)',
          filter: 'blur(80px)',
          pointerEvents: 'none',
          zIndex: 1,
        }}
      ...
      >
        <defs>
          <radialGradient id="dtRadarGrad" cx="400" cy="300" r="350" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="rgba(255,255,204,0.05)" />
            <stop offset="100%" stopColor="rgba(255,255,204,0)" />
          </radialGradient>
          <style>{`
        ...
        {([
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              b.style.borderColor = 'rgba(255,255,204,0.40)';
              b.style.color = '#FFFFCC';
              b.style.boxShadow = '0 0 16px rgba(255,255,204,0.20)';
            }}
            onMouseLeave={e => {
              const b = e.currentTarget;
              b.style.borderColor = 'rgba(255,255,204,0.08)';
              b.style.color = 'rgba(255,255,204,0.70)';
      ...
      >
        <defs>
          ...
          <radialGradient id="dtPitchGlow" cx="50%" cy="50%" r="50%">
            <stop offset="0%"   stopColor="#FFFFCC" stopOpacity="0.06" />
        ...
        <ellipse cx="400" cy="300" rx="340" ry="260" fill="none" stroke="rgba(255,255,204,0.05)" strokeWidth="1" />
        <ellipse cx="400" cy="300" rx="290" ry="215" fill="none" stroke="rgba(255,255,204,0.04)" strokeWidth="0.8" strokeDasharray="6 6" />
        ...
        >
          ...
          <g stroke="rgba(255,255,204,0.12)" strokeWidth="1" strokeDasharray="4 4" fill="none">
          ...
          {/* Pitch markings — rgba(255,255,204,.18) */}
          <g fill="none" stroke="rgba(255,255,204,0.18)" strokeWidth="1.2">
            <rect x="340" y="200" width="120" height="200" rx="6" />
          ...
          <circle cx="400" cy="300" r="1.5" fill="rgba(255,255,204,0.60)" />
          <circle cx="400" cy="224"  r="1"   fill="rgba(255,255,204,0.60)" />
          <circle cx="400" cy="376"  r="1"   fill="rgba(255,255,204,0.60)" />
                  ...
                  <>
                    {zone.status !== 'optimal' && (
                      <circle
                        cx={zone.x} cy={zone.y} r={zone.r + 6}
                        fill="none"
                        stroke={zone.status === 'critical' ? 'rgba(232,108,93,0.50)' : 'rgba(243,201,105,0.50)'}
                        strokeWidth={1.5}
        ...
        {hoveredZone && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 8px 32px rgba(0,0,0,0.60), inset 0 0 0 1px rgba(255,255,204,0.08)',
              zIndex: 30,
              pointerEvents: 'none',
              display: 'flex',
              flexDirection: 'column',
          ...
          >
            ...
            {[
              ...
              <div key={r.label} style={{ display: 'flex', justifyContent: 'space-between', gap: '24px' }}>
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', color: 'rgba(255,255,204,0.40)', letterSpacing: '0.08em' }}>{r.label}</span>
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', color: '#FFFFCC', fontWeight: 700 }}>{r.value}</span>
              </div>
            ))}
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '24px' }}>
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', color: 'rgba(255,255,204,0.40)', letterSpacing: '0.08em' }}>RISK</span>
        ...
        {selectedZone && (
          <motion.div
            ...
            style={{
              ...
              padding: '16px',
              backdropFilter: 'blur(24px)',
              boxShadow: '0 16px 48px rgba(0,0,0,0.70), inset 0 0 0 1px rgba(255,255,204,0.06)',
              zIndex: 20,
              display: 'flex',
              flexDirection: 'column',
            }}
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, letterSpacing: '0.18em', color: '#FFFFCC', textTransform: 'uppercase' }}>
                Zone Inspector
              </span>
              <button
                onClick={() => setSelectedZoneId(null)}
                style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '8px', fontWeight: 700, letterSpacing: '0.10em', color: 'rgba(255,255,204,0.30)', background: 'none', border: 'none', cursor: 'pointer', textTransform: 'uppercase', transition: 'color 150ms' }}
                onMouseEnter={e => ((e.currentTarget as HTMLButtonElement).style.color = 'rgba(255,255,204,0.65)')}
            ...
            <h4 style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', fontWeight: 700, color: '#FFFFCC', letterSpacing: '0.05em', marginBottom: '14px' }}>
              {selectedZone.name}
            </h4>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
              <div style={STAT_TILE}>
                ...
                <span style={STAT_VALUE}>
                  ...
                  <span style={{ fontSize: '9px', fontWeight: 500, color: 'rgba(255,255,204,0.35)', marginLeft: '2px' }}>min</span>
                </span>
              </div>
              <div style={STAT_TILE}>
